...
import com.stackroute.medicinelistService.model.DbSequence;
...
@Service
public class SequenceGeneartor {
    ...
    public String getSequenceNumber(String seqName){
        ...
        DbSequence counter = mongoOperations
                .findAndModify(qry,update,options().returnNew(true).upsert(true),DbSequence.class);
